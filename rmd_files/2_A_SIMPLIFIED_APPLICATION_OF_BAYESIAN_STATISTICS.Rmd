...
The “Monico culture” is a fictitious group of people who might have lived anywhere in the world between the ethnographic present and a long time ago (Figure 1).
```{r fig1, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center",out.width= "\\textwidth", fig.cap="The Monico are a fictitious archaeological culture. These people may lived among a wide range of contexts and settings worldwide between the ethnographic present and a long time ago."}
