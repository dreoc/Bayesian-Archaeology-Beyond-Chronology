...
```{r fig1, echo=FALSE, message=FALSE, warning=FALSE, fig.align = "center",out.width= "\\textwidth", fig.cap="A reconstruction of the fictitious Monico archaeological culture, from the Monico-1 site (see text below)."}
